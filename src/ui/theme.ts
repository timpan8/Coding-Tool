...
export const editorColors: Record<ResolvedTheme, Record<string, string>> = {
  light: {
    ...
    'editorLineNumber.foreground': '#616a76',
    'editorLineNumber.activeForeground': '#5c6470',
    'editor.lineHighlightBackground': '#eef1f4',
    'editor.selectionBackground': '#b3e2c8',
    'editorCursor.foreground': '#067647',
  },
  dark: {
    ...
    'editor.selectionBackground': '#1f5a3c',
    'editorCursor.foreground': '#32d583',
  },
};
