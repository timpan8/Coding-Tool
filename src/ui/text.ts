...
export const sv = {
  ...
  app: {
    ...
    notYetTitle: 'Vad som ännu inte finns',
    notYetBody: 'Kod som kommer tillbaka från en AI matchas inte om mot dina värden automatiskt. Granskningsreglerna fångar det som liknar hemligheter, inte allt som är känsligt hos dig.',
    undone: 'Ångrat.',
